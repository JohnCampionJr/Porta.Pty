 ...
 *
 * Returning -1 from pty_exit_queue is not an error the caller has to handle as a failure: it means
 * this kernel cannot do it, and the caller should keep polling.
 */
